...
! *******************************************************************
! Contains all data decalarations(domain, arrays, BC infor)
! Parameters / Domain
! *******************************************************************
    use petsc
    implicit none
    ...
    real(kind=8), allocatable,dimension (:,:)       ::  SurElev ! Ground Surface Elevations
    ...
    real(kind=8)    :: DELTAT       ! time step size
